...
import SharingGroupInfo from 'src/client/aid_request/detail/rows/SharingGroupInfo';
...
function getListItems(data: AidRequestDetailsQuery | undefined): Array<Item> {
  ...
  return [
    ...
    {
      key: `${aidRequest._id}:sharingGroupInfo`,
      render: () => {
        return <SharingGroupInfo sharingGroup={aidRequest.sharingGroup} />;
      },
    },
    {
