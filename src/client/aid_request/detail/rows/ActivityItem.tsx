...
import { ActivityItemFragment } from 'src/client/aid_request/detail/rows/__generated__/ActivityItemFragment';
import { useColor } from 'src/client/components/Colors';
import Monogram from 'src/client/components/Monogram';
import TextWithMentions from 'src/client/components/text_input_with_styles/TextWithMentions';
