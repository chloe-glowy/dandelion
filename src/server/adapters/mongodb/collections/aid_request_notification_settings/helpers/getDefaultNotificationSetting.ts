import AidRequestNotificationsConfig from 'src/server/adapters/mongodb/collections/aid_request_notification_settings/config/AidRequestNotificationsConfig';
